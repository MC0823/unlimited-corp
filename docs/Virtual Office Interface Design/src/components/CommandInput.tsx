  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        {/* 指令输入框主体 */}
        <motion.div
          className="relative bg-gradient-to-br from-[#2a3f5f] to-[#1e2d42] rounded-3xl shadow-2xl max-w-2xl w-full overflow-hidden"
          style={{
            border: '4px solid #3D7FFF',
            boxShadow: '0 0 60px rgba(61, 127, 255, 0.4)',
          }}
        ...
        >
          {/* 顶部发光条 */}
          <motion.div
            className="absolute top-0 inset-x-0 h-1 bg-gradient-to-r from-transparent via-[#4ECDC4] to-transparent"
            animate={{
              opacity: [1, 0.5, 1],
            }}
            transition={{
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.9 }}
            className="absolute top-6 right-6 z-20 w-10 h-10 rounded-full bg-white/10 backdrop-blur-sm flex items-center justify-center hover:bg-white/20 transition-colors"
          >
          ...
          <div className="relative z-10 p-8">
            ...
            >
              ...
              >
                ...
                <h2 className="text-white text-3xl">AI 指令中枢</h2>
                <Sparkles className="w-8 h-8 text-[#FFD93D]" />
              </motion.div>
              ...
              <div className="relative">
                ...
                <div className="absolute right-2 top-1/2 -translate-y-1/2 flex gap-2">
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.9 }}
                    disabled={!input.trim()}
                    className="w-12 h-12 rounded-xl bg-gradient-to-r from-[#4ECDC4] to-[#44A08D] flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed shadow-lg"
                  >
